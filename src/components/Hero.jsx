...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto">
      <div
        className={`${styles.paddingX} absolute inset-0 top-[85px] max-w-7xl mx-auto flex flex-row items-start gap-5`}
      >
      ...
      <ComputersCanvas />
      <div className="relative bottom-32 xs:bottom-10  w-full flex justify-center items-center ">
        <a href="#about">
